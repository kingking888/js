//原登录参数信息
// jsonp: jQuery17202283546050101919_1618033220708
// protocol: http:
// loginIndex: http://www.xinshangmeng.com/xsm2/?Version=2019060900
// j_mmrm: 123456
// j_mcmm: c4fe347bb482ab2448c87efeccca73d2
// j_valcode: 0316
// _: 1618033294618

function get_post_data(username, pwd, captcha) {
    input_data = {
        'username': username,
        'pwd': pwd,
        'captcha': captcha
    ...
    return post_data = {
        ...
        "protocol": "http:",
        "loginIndex": "http://www.xinshangmeng.com/xsm2/?Version=2019060900",
        "j_mmrm": input_data.username,
        "j_mcmm": F(F(input_data.pwd) + input_data.captcha),
        "j_valcode": input_data.captcha,
        "_": "1618033294618"
    };
}

console.log(get_post_data('123456','12','1234'))
